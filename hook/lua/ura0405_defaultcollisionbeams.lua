...
RetributionGreenLaserCollisionBeam = Class(SCCollisionBeam) {
    ...
    FxBeamStartPoint = {
        '/mods/4th_Dimension_302/hook/effects/emitters/ura0305_green_beampoint_01_emit.bp',
    },

    FxBeam = {'/mods/4th_Dimension_302/hook/effects/emitters/ura0305_green_laser_beam_emit.bp'},
    ...
    FxImpactUnit = {
        '/mods/4th_Dimension_302/hook/effects/emitters/ura0305_green_hit_unit_emit.bp',
        '/mods/4th_Dimension_302/hook/effects/emitters/ura0305_beam_hit_sparks_emit.bp',
